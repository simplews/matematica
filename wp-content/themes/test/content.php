...
?>
        ...
        <p class="text-right">
            <a class="btn btn-primary" href="<?php the_permalink(); ?>#comments"><?php comments_number( __( 'Leave a Comment', 'matematica-test' ), __( 'One Comment', 'matematica-test' ), '%' . __( ' Comments', 'matematica-test' ) );?> <span class="fa fa-comments"></span></a>
        </p>
<?php
      endif;
